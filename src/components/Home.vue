...
<template>
  <section id="home">
    ...
    <div id="stars2"></div>
    <div id="stars3"></div>
    <div class="container d-flex between responsive">
      <div>
        <!-- <h1>
          Ciao,<br />
          sono <span>Antonio</span><br />
          Full Stack Developer
        </h1> -->
        <h1 class="typing-1">Ciao,</h1>
        <h1 class="typing-2">sono <span>Antonio</span></h1>
        <h1 class="typing-3">Full Stack Developer</h1>
        <button class="btn"><a href="#contact">CONTATTAMI</a></button>
        <ul class="flex-mix gap-10 icons-home">
          <li>
            <a href="https://www.linkedin.com/in/antonino-iorfida-4723a72ba" target="_blank"
              rel="noopener noreferrer"><i class="fab fa-linkedin"></i></a><span>LinkedIn</span>
          </li>
          <li>
            <a href="#"><i class="fab fa-github"></i></a><span>GitHub</span>
          </li>
          <li>
            <a href="https://www.instagram.com/antoo_iorfida/" target="_blank"
            rel="noopener noreferrer"><i class="fab fa-instagram"></i></a><span>Instagram</span>
          </li>
        </ul>
      </div>
...
.typing-1 {
  width: 80px;
  animation: typing-1 1s steps(22), blink .5s step-end infinite alternate;
  white-space: nowrap;
  overflow: hidden;
...
.typing-2 {
  width: 200px;
  animation: typing-2 2s steps(22), blink .5s step-end infinite alternate, appear 0s forwards;
  opacity: 0;
  white-space: nowrap;
  overflow: hidden;
  //border-right: 3px solid;
...
.typing-3 {
  width: 300px;
  animation: typing-3 3s steps(22), blink .5s step-end infinite alternate, appear 0s forwards;
  opacity: 0;
  white-space: nowrap;
  overflow: hidden;
  border-right: 3px solid;
